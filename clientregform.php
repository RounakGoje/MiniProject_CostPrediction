...
<?php
	...
	<nav>
      <ul>
        ...
        <li><a href="http://localhost/p/miniproject/clientlogin.php">Login</a></li>
      </ul>
    </nav>
...
<div class="form">
		...
		<form name="f1" action="<?php echo htmlentities($_SERVER['PHP_SELF']); ?>" method="POST">
			...
			<p>PassCode:</p>
            <input type="password" name="otp" placeholder="0000"  pattern="[0-9]{4}" title="PassCode should be in '0000' this format and used for 2 setp verification process" required>
